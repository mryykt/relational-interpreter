...
(defrel (limitedo src env t)
        (matche src
                [(app ,u ,v) (fresh (t0) (limitedo u env `(,t0 -> ,t)) (limitedo v env t0))]
     ...
     (map unparser
          (run n
               ...
               (fresh (env tenv o)
                      ...
                      (limitedo q tenv t)
                      (evalo (with-all-functions (apps ,q input ...)) o)
                      (== o output))))]
...
(define (run-test)
  (test
   "reverse"
   (synthesis 1 '((list char) -> (list char)) (foldlEmptyf) (,(string-c "hello")) (string-v "olleh"))
  ...
  (test "sum"
        (synthesis 1 '((list int) -> int) (foldlf) (,(list-c 1 2 3)) (build-num 6))
        '((foldl add 0)))
  (test "isort"
        (synthesis 1
                   '((list int) -> (list int))
  ...
  (test "adds"
        ...
        '((compose map add)))
  (test "length"
        (synthesis 1 '((list char) -> int) (foldr0f) (,(string-c "123")) (build-num 3))
        '((foldr0 (const (add 1)))))
  (test "rember"
        (synthesis 1
        ...
        '((compose filter neq)))
  (test "maximize"
        (synthesis 1 '((list int) -> int) (foldr1f) (,(list-c 1 2 3 2 1)) (build-num 3))
        '((foldr1 max)))
  (test "minimize"
        (synthesis 1 '((list int) -> int) (foldr1f) (,(list-c 3 2 5 2 3)) (build-num 2))
        '((foldr1 min)))
  (test "uniq"
        (synthesis 1
                   '((list char) -> (list char))
